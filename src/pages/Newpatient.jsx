...
function Newpatient() {
  ...
  <div class="row">
    <div class="col-sm-8" style={{textAlign:"left",lineHeight: "1rem",marginTop:"3vh"}}>
        <h4 style={{color:"#548eaf"}}>New Patient Forms</h4><br/><br/>
        <b>Dentistry by Design</b><br/><br/>
        <b>Patient forms</b><br/><br/>
        <b style={{color:"#548eaf"}}>Patient Login Link

        </b><br/><br/>
        <b style={{color:"#548eaf"}}>New Patient Forms Link</b><br/><br/>
        <p>If you have any questions, call us at (630) 325-2525.</p><br/><br/>
